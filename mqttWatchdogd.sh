...
### BEGIN INIT INFO
# Provides:          MqttWatchdogDeamon
# Required-Start:    $remote_fs $named $syslog
# Required-Stop:     $remote_fs $named $syslog
# Default-Start:     2 3 4 5
# Default-Stop:      0 1 6
# Short-Description: DEBIAN initscript for node.js Mqtt Watchdog app
# Description:       This node js driven service is used for sending e-mail alerts if a mqtt topic is silent for too long
...
DAEMON_ARGS="/home/pi/0_PublicHub/0_GIT/mqttWatchdog/mqttWatchdog.js -c /home/pi/0_PublicHub/0_GIT/CONFIG/mqttWatchdog/config.json"               # path to your node.js server/app
                                            # NB: don't use ~/ in path

DESC="Mqtt Watchdog checks if mqtt topics are active"  # whatever fancy description you like
